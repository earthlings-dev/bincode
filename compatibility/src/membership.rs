...
// License: Openraft is licensed under the terms of the MIT License or the Apache License 2.0, at
// your choosing.
...
#[derive(bincode::Encode, bincode::Decode, serde::Serialize, serde::Deserialize, Debug, PartialEq, Eq)]
...
fn vec_random_btreeset(rng: &mut impl RngExt) -> Vec<BTreeSet<NodeId>> {
...
fn random_btreeset(rng: &mut impl RngExt) -> BTreeSet<NodeId> {
