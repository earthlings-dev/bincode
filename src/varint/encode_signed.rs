...
pub fn varint_encode_i16<W: Writer>(writer: &mut W, endian: Endianness, val: i16) -> Result<(), EncodeError> {
  varint_encode_u16(
    writer,
    endian,
    if val < 0 {
...
pub fn varint_encode_i32<W: Writer>(writer: &mut W, endian: Endianness, val: i32) -> Result<(), EncodeError> {
  varint_encode_u32(
    writer,
    endian,
    if val < 0 {
...
pub fn varint_encode_i64<W: Writer>(writer: &mut W, endian: Endianness, val: i64) -> Result<(), EncodeError> {
  varint_encode_u64(
    writer,
    endian,
    if val < 0 {
...
pub fn varint_encode_i128<W: Writer>(writer: &mut W, endian: Endianness, val: i128) -> Result<(), EncodeError> {
  varint_encode_u128(
    writer,
    endian,
    if val < 0 {
...
pub fn varint_encode_isize<W: Writer>(writer: &mut W, endian: Endianness, val: isize) -> Result<(), EncodeError> {
...
fn test_encode_i32() {
  let cases: &[(i32, &[u8], &[u8])] = &[
    ...
    (i32::MAX - 1, &[super::U32_BYTE, 252, 255, 255, 255], &[super::U32_BYTE, 255, 255, 255, 252]),
    (i32::MAX, &[super::U32_BYTE, 254, 255, 255, 255], &[super::U32_BYTE, 255, 255, 255, 254]),
  ];
...
fn test_encode_i64() {
  let cases: &[(i64, &[u8], &[u8])] = &[
    ...
    (16_000, &[super::U16_BYTE, 0, 125], &[super::U16_BYTE, 125, 0]),
    (40_000, &[super::U32_BYTE, 128, 56, 1, 0], &[super::U32_BYTE, 0, 1, 56, 128]),
    (3_000_000_000, &[super::U64_BYTE, 0, 188, 160, 101, 1, 0, 0, 0], &[super::U64_BYTE, 0, 0, 0, 1, 101, 160, 188, 0]),
    (i64::MAX - 1, &[super::U64_BYTE, 252, 255, 255, 255, 255, 255, 255, 255], &[super::U64_BYTE, 255, 255, 255, 255, 255, 255, 255, 252]),
    (i64::MAX, &[super::U64_BYTE, 254, 255, 255, 255, 255, 255, 255, 255], &[super::U64_BYTE, 255, 255, 255, 255, 255, 255, 255, 254]),
  ];
