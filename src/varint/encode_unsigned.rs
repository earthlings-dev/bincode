...
pub fn varint_encode_u16<W: Writer>(writer: &mut W, endian: Endianness, val: u16) -> Result<(), EncodeError> {
...
pub fn varint_encode_u32<W: Writer>(writer: &mut W, endian: Endianness, val: u32) -> Result<(), EncodeError> {
  if val <= SINGLE_BYTE_MAX as _ {
    writer.write(&[val as u8])
...
pub fn varint_encode_u64<W: Writer>(writer: &mut W, endian: Endianness, val: u64) -> Result<(), EncodeError> {
  if val <= SINGLE_BYTE_MAX as _ {
    writer.write(&[val as u8])
  } else if val <= u16::MAX as _ {
    writer.write(&[U16_BYTE])?;
...
pub fn varint_encode_u128<W: Writer>(writer: &mut W, endian: Endianness, val: u128) -> Result<(), EncodeError> {
  if val <= SINGLE_BYTE_MAX as _ {
    writer.write(&[val as u8])
  } else if val <= u16::MAX as _ {
    writer.write(&[U16_BYTE])?;
...
pub fn varint_encode_usize<W: Writer>(writer: &mut W, endian: Endianness, val: usize) -> Result<(), EncodeError> {
