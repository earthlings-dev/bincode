...
/// Any source that can be encoded. This trait should be implemented for all types that you want to
/// be able to use with any of the `encode_with` methods.
///
/// This trait will be automatically implemented if you enable the `derive` feature and add
/// `#[derive(bincode::Encode)]` to your trait.
///
/// # Implementing this trait manually
///
/// If you want to implement this trait for your type, the easiest way is to add a
/// `#[derive(bincode::Encode)]`, build and check your `target/generated/bincode/` folder. This
/// should generate a `<Struct name>_Encode.rs` file.
///
/// For this struct:
///
/// ```
