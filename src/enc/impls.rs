...
impl Encode for u16 {
  fn encode<E: Encoder>(&self, encoder: &mut E) -> Result<(), EncodeError> {
    match E::C::INT_ENCODING {
      IntEncoding::Variable => crate::varint::varint_encode_u16(encoder.writer(), E::C::ENDIAN, *self),
...
impl Encode for u32 {
  fn encode<E: Encoder>(&self, encoder: &mut E) -> Result<(), EncodeError> {
    match E::C::INT_ENCODING {
      IntEncoding::Variable => crate::varint::varint_encode_u32(encoder.writer(), E::C::ENDIAN, *self),
      IntEncoding::Fixed => match E::C::ENDIAN {
        Endianness::Big => encoder.writer().write(&self.to_be_bytes()),
        Endianness::Little => encoder.writer().write(&self.to_le_bytes()),
      },
...
impl Encode for u64 {
  fn encode<E: Encoder>(&self, encoder: &mut E) -> Result<(), EncodeError> {
    match E::C::INT_ENCODING {
      IntEncoding::Variable => crate::varint::varint_encode_u64(encoder.writer(), E::C::ENDIAN, *self),
      IntEncoding::Fixed => match E::C::ENDIAN {
        Endianness::Big => encoder.writer().write(&self.to_be_bytes()),
        Endianness::Little => encoder.writer().write(&self.to_le_bytes()),
      },
...
impl Encode for u128 {
  fn encode<E: Encoder>(&self, encoder: &mut E) -> Result<(), EncodeError> {
    match E::C::INT_ENCODING {
      IntEncoding::Variable => crate::varint::varint_encode_u128(encoder.writer(), E::C::ENDIAN, *self),
      IntEncoding::Fixed => match E::C::ENDIAN {
        Endianness::Big => encoder.writer().write(&self.to_be_bytes()),
        Endianness::Little => encoder.writer().write(&self.to_le_bytes()),
      },
...
impl Encode for usize {
  fn encode<E: Encoder>(&self, encoder: &mut E) -> Result<(), EncodeError> {
    match E::C::INT_ENCODING {
      IntEncoding::Variable => crate::varint::varint_encode_usize(encoder.writer(), E::C::ENDIAN, *self),
      IntEncoding::Fixed => match E::C::ENDIAN {
...
impl Encode for i16 {
  fn encode<E: Encoder>(&self, encoder: &mut E) -> Result<(), EncodeError> {
    match E::C::INT_ENCODING {
      IntEncoding::Variable => crate::varint::varint_encode_i16(encoder.writer(), E::C::ENDIAN, *self),
      IntEncoding::Fixed => match E::C::ENDIAN {
        Endianness::Big => encoder.writer().write(&self.to_be_bytes()),
        Endianness::Little => encoder.writer().write(&self.to_le_bytes()),
      },
...
impl Encode for i32 {
  fn encode<E: Encoder>(&self, encoder: &mut E) -> Result<(), EncodeError> {
    match E::C::INT_ENCODING {
      IntEncoding::Variable => crate::varint::varint_encode_i32(encoder.writer(), E::C::ENDIAN, *self),
      IntEncoding::Fixed => match E::C::ENDIAN {
        Endianness::Big => encoder.writer().write(&self.to_be_bytes()),
        Endianness::Little => encoder.writer().write(&self.to_le_bytes()),
      },
...
impl Encode for i64 {
  fn encode<E: Encoder>(&self, encoder: &mut E) -> Result<(), EncodeError> {
    match E::C::INT_ENCODING {
      IntEncoding::Variable => crate::varint::varint_encode_i64(encoder.writer(), E::C::ENDIAN, *self),
      IntEncoding::Fixed => match E::C::ENDIAN {
        Endianness::Big => encoder.writer().write(&self.to_be_bytes()),
        Endianness::Little => encoder.writer().write(&self.to_le_bytes()),
      },
...
impl Encode for i128 {
  fn encode<E: Encoder>(&self, encoder: &mut E) -> Result<(), EncodeError> {
    match E::C::INT_ENCODING {
      IntEncoding::Variable => crate::varint::varint_encode_i128(encoder.writer(), E::C::ENDIAN, *self),
      IntEncoding::Fixed => match E::C::ENDIAN {
        Endianness::Big => encoder.writer().write(&self.to_be_bytes()),
        Endianness::Little => encoder.writer().write(&self.to_le_bytes()),
      },
...
impl Encode for isize {
  fn encode<E: Encoder>(&self, encoder: &mut E) -> Result<(), EncodeError> {
    match E::C::INT_ENCODING {
      IntEncoding::Variable => crate::varint::varint_encode_isize(encoder.writer(), E::C::ENDIAN, *self),
      IntEncoding::Fixed => match E::C::ENDIAN {
  ...
  T: Encode,
{
  fn encode<E: Encoder>(&self, encoder: &mut E) -> Result<(), EncodeError> {
    if unty::type_equal::<T, u8>() {
      // Safety: this is &[u8; N]
      let array_slice: &[u8] = unsafe { core::slice::from_raw_parts(self.as_ptr().cast(), N) };
  ...
  fn encode<E: Encoder>(&self, encoder: &mut E) -> Result<(), EncodeError> {
    let borrow_guard = self
      ...
      .map_err(|e| EncodeError::RefCellAlreadyBorrowed {
        inner: e, type_name: core::any::type_name::<RefCell<T>>()
      })?;
